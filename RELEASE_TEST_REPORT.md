...
- Generated: 2026-09-13 16:33:17 -0700
- Python running gate: 3.12.12
- Repository: `embedflow` (local release checkout)
- Git commit: 052b1a3 (working tree has uncommitted changes)
...
|---|---|---|---:|
| public pytest suite | PASS | exit=0 | 6.29 |
| pgvector Docker integration | SKIP | SKIPPED [1] tests/test_pgvector_docker.py:27: Docker unavailable: permission denied while trying to connect to the docker API at unix:///var/run/docker.sock | 0.88 |
| Milvus Docker integration | SKIP | Milvus Docker integration was skipped | 0.88 |
| Weaviate Docker integration | SKIP | SKIPPED [1] tests/test_weaviate_docker.py:32: set EMBEDFLOW_RUN_WEAVIATE_DOCKER=1 to run the 10k Weaviate integration | 0.85 |
...
| package build | PASS | exit=0 | 2.71 |
...
| CLI Qdrant demo | PASS | exit=0 | 4.76 |
...
| research example command 2 | PASS | exit=0 | 0.27 |
| Qdrant example command 1 | PASS | exit=0 | 1.32 |
| Qdrant example command 2 | PASS | exit=0 | 1.27 |
...
| Python 3.12 smoke | PASS | exit=0 | 6.32 |
